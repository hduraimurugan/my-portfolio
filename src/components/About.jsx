                ...
                <div className='md:w-1/2 flex justify-center'>
                    <div className='flex flex-col justify-center px-10 py-10'>
                        ...
                        <ul className='list-none text-white'>
                            ...
                            <li>
                                <p className='text-white text-justify md:text-2xl text-xl font-list-font mt-5'> My passion for the technology led me to transition into web development, where I gained expertise in <span className='font-bold'>HTML, CSS, JavaScript, ReactJS, NodeJS, MongoDB</span> and more. </p>
                            </li>
                            <li>
