                                    ...
                                    <DialogTrigger asChild>
                                        ...
                                        >
                                            <div className="bg-gray-100 p-4 rounded-lg shadow-md w-full">
                                                ...
                                                <p className="text-gray-600 md:text-md text-sm">Guvi Geek Network, IIT Madras</p>
                            ...
                            <div className="flex items-start space-x-2 mb-10">
                                <Dialog>
                                    <DialogTrigger asChild>
                                        ...
                                        >
                                            <div className="bg-gray-100 p-4 rounded-lg shadow-md w-full">
                                                <h3 className="md:text-xl text-md font-medium">Bachelor of Technology in Electronics and Instrumentation Engineering</h3>
                                                <p className="text-gray-600 md:text-md text-sm">Kalasalingam Academy of Research Education</p>
                                ...
                                <Dialog>
                                    <DialogTrigger asChild>
                                        ...
                                        > <div className="bg-gray-100 p-4 rounded-lg shadow-md w-full">
                                                ...
                                                <p className="text-gray-600 md:text-md text-sm">Rosemary Matric Higher Secondary School</p>
